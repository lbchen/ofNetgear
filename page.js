    ...
    id : {
        ...
        modal : {
            ...
            action : {
                ...
                // {add qos:lbc:0726}
                enqueue : "one_f_flows_id_modal_action_enqueue",
            ...
            parse : function(option) {
                switch (option) {
                    ...
                    case "setVlanId" :
                        ...
                        var $modalcallback = one.f.flows.modal.action.initialize(h3, body, add);
                        $modal.modal();
                        break;
